<html>
    <link rel="stylesheet" type="text/css" href="CSS/estiloRegisto.css">
    ...
    <div class=pai>
        ...
        <div class="filho">
            <div class="titulo">Register your new account</div>
            <div class="borders border1"><input type="text" placeholder="Primeiro Nome"></div>
            <div class="borders"><input type="text" placeholder="Ultimo Nome"></div>
